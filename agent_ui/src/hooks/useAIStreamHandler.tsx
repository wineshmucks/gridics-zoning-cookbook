  ...
  const handleStreamResponse = useCallback(
    async (input: string | FormData) => {
      ...
      try {
        ...
        if (selectedMarketArea && selectedMarketArea !== 'auto') {
          formData.append(
            'dependencies',
            JSON.stringify({
              market_area: selectedMarketArea,
              state_env: selectedMarketArea
            })
          )
          formData.append(
            'metadata',
            JSON.stringify({ market_area: selectedMarketArea })
          )
          formData.append('add_dependencies_to_context', 'true')
        }
