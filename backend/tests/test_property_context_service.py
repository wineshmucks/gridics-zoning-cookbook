...
class DummyGridicsAdapter:
    ...
    def get_property_record_by_coordinates(self, *, latitude: float, longitude: float) -> dict[str, object]:
        self.calls.append({"kind": "coordinates", "latitude": latitude, "longitude": longitude})
...
def test_property_context_falls_back_to_address_lookup_when_gridics_requires_state_env() -> None:
    ...
    assert adapter.calls == [
        {"kind": "coordinates", "latitude": 25.732787, "longitude": -80.239989},
        {
            "kind": "address",
            "state_code": "fl",
            "address": "3148 Mary Street, Miami, Florida 33133, United States",
