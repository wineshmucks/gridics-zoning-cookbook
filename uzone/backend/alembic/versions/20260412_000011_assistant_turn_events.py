...
def downgrade() -> None:
    op.drop_index("ix_assistant_turn_events_policy_decision", table_name="assistant_turn_events")
    op.drop_index("ix_assistant_turn_events_tenant_created_at", table_name="assistant_turn_events")
    op.drop_table("assistant_turn_events")
