    ...
    try:
        tenant = add_tenant_client(
            ...
            settings_json={
                ...
                "assistant_provider_keys": {"openai": "key-1"},
                "assistant_model_targets": {"assistant": {"provider": "openai", "model_id": "gpt-5"}},
        ...
        updated_experience = admin.update_tenant_experience_settings(
            ...
            TenantExperienceSettingsUpdate(
                ...
                assistant_provider_keys={"openai": "key-2"},
                assistant_model_targets={"assistant": {"provider": "openai", "model_id": "gpt-5.1"}},
                assistant_agent_prompts={"assistant": "Be concise."},
            ),
            db=db,
        )
        assert updated_experience.zoning_code_url == "https://example.com/zoning-updated"
        assert updated_experience.debug_received_assistant_provider_keys["openai"] == "key-2"
        ...
        updated_platform = admin.update_platform_assistant_settings_route(
            PlatformAssistantSettingsUpdate(
                ...
                assistant_provider_keys={"openai": "platform-key"},
                assistant_model_targets={"assistant": {"provider": "openai", "model_id": "gpt-5"}},
